...
@plugindesc Changed the maximum number of battle members Ver. 2.0.3 (2025/1/20)
@author PotatoDragon
@license MIT License
...
## Overview
Change the maximum number of battle members.

## How to Use
1. Set the "Maximum Number of Battle Members" plugin parameter.
2. The maximum number of battle members will change when you start the game.
...
@text Maximum number of battle members variable
@desc Variable to manage the maximum number of battle members
@type variable
@default 0
@parent MaxBattleMembers

@param MaxInBattleMember
@text Change the maximum number of battle members during battle
@desc Do you want to change the number of battle members during battle?
@type boolean
@on Change
@off Do not change
@default false
...
@text Maximum number of battle members during battle
@desc Maximum number of battle members in battle
@type number
@default 5
@min 1
@max 999999999999999
...
@text Maximum number of battle members during battle
@desc Variable that manages the maximum number of battle members during a battle
@type variable
@default 0
@parent MaxInBattleMember

@param EnableBattleMenu
@text Battle Menu Expansion
@desc Whether to expand the battle menu display based on the number of players
@type boolean
@on Expand
@off Do not expand
@default true
...
@param FiveParty
@text Menu for 5 people
@desc Change the menu display for 5 people
@type boolean
@on Change
@off Do not change
@default false
