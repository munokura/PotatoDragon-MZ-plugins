...
@plugindesc Unsellable Ver1.0.0 (2025/1/1)
@author PotatoDragon
@license MIT License
...
## Overview
Adds a notetag to make items unsellable, even if a price has been specified.

## Usage
1. Write <No Sale> or <Hide for Sale> in the memo field of the item, weapon,
or armor.
2. The item will be unsellable when sold in a shop.

### Notetag Description
Enter one of the following tags in the memo field of the item, weapon, or
armor.

<No Sale>
This tag will make the item unsellable. It will still be displayed in the
list.

<Hide for Sale>
This tag will not be displayed in the sales list.

* The tag name can also be changed using the plugin parameters.

### Parameter Description

#### No Sale Tag (NoSaleMetaName)
Specifies the name of the <No Sale> tag.

#### Hide for Sale Tag (NoViewMetaName)
Specifies the name of the <Hide for Sale> tag.
