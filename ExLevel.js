...
@plugindesc Lv Reference Control Character Ver1.0.1 (2025/7/22)
@author PotatoDragon
@license MIT License
...
## Overview
Adds the control character \Lv to reference the level.

## Usage
By writing \Lv[Actor ID] OR \Lv[Actor Name],
you can reference the level of the corresponding actor.
*/
