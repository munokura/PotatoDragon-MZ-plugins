...
@plugindesc Actor Equipment Ver1.0.4 (2025/7/22)
@author PotatoDragon
@license MIT License
...
## Overview
Adds the ability to equip actors in the equipment memo field.
...
@param ActorEquip
@text Friend Tag
@desc Name of memo tag to be equipped to actor
@default Friend

@param Only
@text Only tag
@desc Name of the memo tag for armor that can only be equipped once
@default Only
*/
