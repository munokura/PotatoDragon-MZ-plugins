...
@plugindesc Name Switch Ver1.0.0 (2025/1/1)
@author PotatoDragon
@license MIT License
...
## Overview
Adds a plugin command called "Name Switch" that turns switches on and off by
name.

## Usage
1. Select the plugin command from the event command.
2. Specify "Name Switch" as the plugin name.
* "Name Switch" will be automatically selected as the command name.
3. Enter the switch name in the "Switch Name" argument.
4. Select ON/OFF in the "Operation" argument.

### Plugin Command Description

#### Name Switch
A plugin command that turns switches on and off by name.
...
@command switch_name
@text Name Switch
@desc Invoke a switch by name
@arg SwitchName
@text Switch Name
@desc Specifying a switch by name
@type string

@arg switch
@text For switch name search
