...
@plugindesc Currency Unit Switch Ver1.3.7 (2023/9/11)
@author PotatoDragon
@license MIT License
...
## Overview
Switch between two currency units using the plugin command.
The currency unit will switch when you use the "Currency Switch" plugin
command.

## Usage

### Usage Example 1 (Prize Exchange)

This process is assumed at installation.
You can create a prize exchange by setting the event execution details as
follows.

◆ Plugin Command: CurrencyUnit, Currency Switch
◆ Shop Execution: Potion
◆ Plugin Command: CurrencyUnit, Currency Switch

Change the prize contents in the shop execution.
Also, limiting the shop execution to purchases will create a more realistic
prize exchange.

### Usage Example 2 (Second Currency)

By changing the parameters as follows and setting the event execution details
as follows, you can set a second world currency, such as the yen.

Location transfer is specified, but this is not necessary.
The currency will switch when the plugin is called.

Parameters
Purchase Command Name: Purchase
Second Currency Name: Yen
...
◆ Plugin Command: CurrencyUnit, Currency Switch
◆ Location: Fantasy World (0,0)

@param CurrencyUnitSwitch
@text Currency switch
@desc Switch to second currency when ON
@type switch
@default 25

@param CurrencyVariable
@text Currency Switching Variable
@desc Variable ID for temporary currency management
@type variable
@default 30
...
@param SecondBuyRate
@text Second Currency Buying Rate
@desc Second currency purchase multiplier
@type number
@default 1.00
@min 0
@decimals 2
...
@text Second Currency Selling Rate
@desc Second currency selling rate
@type number
@default 0.50
@min 0
@decimals 2
