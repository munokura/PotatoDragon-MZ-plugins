...
@plugindesc MV Base Ver0.8.7 (2022/9/10)
@author PotatoDragon
@license MIT License
...
## Overview
This is an MV-based plugin.
It allows you to run a certain number of MV plugins as is.
* Because the core script has been modified and new features have been added,
there is a high possibility of conflicts.

## How to Use
1. Place this plugin above the MV plugin you want to use.

No other configuration is required.
Since this plugin is still in development, only a few MV plugins will work
with it.

Also, this plugin is designed to minimize interference with MZ plugins.
As a result, even when the plugin is complete,
there may be MV plugins that simply won't work.

@param RectFix
@text Rect support
@desc Supports Windows Rect added from MZ
@type boolean
@on handle
@off Not supported
@default true
