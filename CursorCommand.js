...
/*:
@target MZ
@url https://raw.githubusercontent.com/pota-gon/RPGMakerMZ/refs/heads/main/plugins/Scene/Menu/CursorCommand.js
@plugindesc Added menu command cursor movement Ver1.4.5 (2022/9/10)
@author PotatoDragon
@license MIT License
...
## Overview
Add the same functionality to menu commands using the ←→ or QW keys.
...
@param MenuOk
@text Menu ← key to confirm
@desc Make the Left arrow key the same as "Confirm" in the menu
@type boolean
@default false

@param MenuStatusCancel
@text Menu Status → Key Cancel
@desc In menu status, press → key to cancel
@type boolean
@default true

@param ItemCategoryQW
@text Item Category QW Operation
@desc Make QR the same as the left and right keys in the item category
@type boolean
@default true

@param SkillTypeCursor
@text Skill Type ←→ Operation
@desc Make ←→ the same as the QR key in skill type
@type boolean
@default true

@param StatusTypeCursor
@text Status ←→ Operation
@desc Make ←→ in status the same as QR key
@type boolean
@default true
*/
