...
@plugindesc Name Window Automation Ver1.3.6 (2024/11/3)
@author PotatoDragon
@license MIT License
...
## Overview
The name will be set automatically to some extent even if you don't enter
anything in the name window.
...
@text Name Window Exclude Event Name
@desc When displaying text in a normal window, the event name is
@default EV
*/
