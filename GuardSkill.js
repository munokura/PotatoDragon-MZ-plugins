...
/*:
@target MZ
@url https://raw.githubusercontent.com/pota-gon/RPGMakerMZ/refs/heads/main/plugins/Data/Skill/GuardSkill.js
@plugindesc Defense Skill Ver1.0.0 (2025/1/1)
@author PotatoDragon
@license MIT License
...
## Overview
Adds a note tag that changes defensive skills.

## How to Use
1. Create the skill you want to use as a defensive skill.
2. Write <Defensive Skill: Evade> in the note. (This will change Defense to
Evade.)
3. When combat begins, Defense will switch to Evade.
* Items can also be set in the same way.

You can specify the defensive skill by skill name or skill ID.
As an added bonus, you can also change the attack skill by adding <Attack
Skill: Fire>.
...
@desc Do you want to change the normal attack command name?
@type boolean
@on Change
@off Do not change
@default true
...
@text Defense command name change
@desc Change the name of the defense command?
@type boolean
@on Change
@off Do not change
@default true
