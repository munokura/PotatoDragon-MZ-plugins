...
@plugindesc TP Ver1.0.2 (2023/12/9)
@author PotatoDragon
@license MIT License
...
## Usage
Change TP-related parameters as needed.

@param MaxTp
@text TP Maximum
@desc Maximum Take Profit
@type number
@default 100

@param FixedTp
@text TP initialization fixed
@desc Whether to fix the TP initialization value
@type boolean
@on Make it fixed
@off Do not fix
@default true
...
@param InitTp
@text Initial TP value at the start of battle
@desc Initial TP value at the start of battle
@type number
@default 0
@parent FixedTp

@param NoChargeTpDamage
@text Does not recover TP when taking damage
@desc Whether to recover TP when taking damage
@type boolean
@on No recovery
@off recover
@default true
