...
@plugindesc Item name reference control characters Ver1.2.5 (2023/7/9)
@author PotatoDragon
@license MIT License
...
## Overview
Adds the control character \II to reference item names.

## Usage
By entering an item name like \II[Potion],
the icon and item name will be displayed like this: [Icon]Potion.

You can also specify weapons and armor as item names.
If there are multiple items with the same name, the first item name found will
be displayed.
*/
