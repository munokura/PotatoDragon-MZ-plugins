...
@plugindesc Equipment Release Ver1.0.3 (2025/5/29)
@author PotatoDragon
@license MIT License
...
## Overview
Adds an equipment release feature that's even more powerful than equipment
seal.

## Usage
In the memo field for an actor, class, weapon, armor, or state, enter
<Equipment Release: 2> or <Equipment Release: Shield> (if specifying an ID).
This will allow you to equip equipment that's been sealed with equipment seal.

Example: This allows you to create a large man wielding a greatsword in one
hand.

@param ReleaseEquipMetaName
@text Equipment Release Tag
@desc Name of the memo tag used to release equipment
@default 装備解放
*/
