...
@plugindesc Quiz Ver1.0.3 (April 1, 2022)
@author PotatoDragon
@license MIT License
...
## Overview
Makes the "Show Choices" event command more quiz-like.

## Usage
1. Select the "Quiz Choices" plugin command.
2. Enter the question using the "Show Text" event command.
3. Create the choices using the "Show Choices" event command.
4. Feel free to implement subsequent processing based on whether the choice is
correct.
5. Select the "End Quiz" plugin command.

@command quiz_choices
@text Quiz Choices
@desc Change the event command "Display Choices" to a quiz format
