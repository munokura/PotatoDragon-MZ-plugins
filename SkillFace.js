...
@plugindesc Face graphics displayed on the battle skill screen Ver1.0.0 (2025/1/1)
@author PotatoDragon
@license MIT License
...
## Overview
Enables display of face graphics in the help section of the combat skill
screen.

## Usage
1. Specify the graphic name and index in the skill's memo field, such as <Face
Graphic: Actor3, 0>.
2. You can add a description to the third line by specifying <Additional
Description: Additional Description>.
3. When you enter combat, the face graphic will be displayed when viewing the
skill description.

@param ShowSkillMenu
@text Menu Skills Face Graphic Display
@desc Display face graphics in menu skills
@type boolean
@on Show
@off Do not display
@default true
...
@param HalfFace
@text Face graphic half size
@desc Should I halve the size of the face graphic?
@type boolean
@on Halve (50%)
@off Don't halve it (100%)
@default true
...
@text Command/status display availability
@desc Command status display availability
@type boolean
@on Show
@off Do not display
@default true
