...
@plugindesc Debugging plugin Ver1.5.1 (2025/8/6)
@author PotatoDragon
@license MIT License
...
## Overview
Adding useful features during development

## How to Use
The following features are provided.
Please change the parameters of the features you want to use.

1. Skip plugin load errors
2. Change screen size (resolution) with a plugin
3. Change fonts with a plugin
4. Obtain all items
5. Always escape
...
@text Skip plugin load errors
@desc Skip plugin load errors?
@type boolean
@on Skip
@off Don't skip
@default true
...
@text Change screen size (resolution)
@desc Change screen size (resolution) with a plugin
@type boolean
@on Change
@off Do not change
@default false
...
@text Screen size (resolution) width
@desc Horizontal length of the screen
@type number
@default 816
@min 0
@max 2000
...
@text Screen size (resolution) height
@desc Screen height
@type number
@default 624
@min 0
...
@param EnableFont
@text Change font with plugin
@desc Change fonts to be switched by plugin
@type boolean
@default false

@param mainFontFilename
@text Main Font
@desc Main font filename
@type string
...
@text Number font
@desc Number font filename
@type string
@default mplus-2p-bold-sub.woff
@parent EnableFont

@param AllItem
@text Obtain all items
@desc Do you get all the items?
@type boolean
@on Get it
@off Don't get it
@default false
...
@text Character array of the item name that you do not want to obtain (partial match)
@desc If it contains any of these characters, you will not receive the item.
@type string[]
@default ["-"]
@parent AllItem

@param ExceptItemExactNames
@text Character sequence of the item name that you do not want to obtain (exact match)
@desc If this item name is given, you will not get the item.
@type string[]
@default []
@parent AllItem
...
@param GetWeapon
@text Obtaining weapons
@desc Do you get weapons?
@type boolean
@on Get it
@off Don't get it
@default true
...
@text Number of weapons obtained
@desc Number of weapons acquired
@type number
@default 0
@min 0
@max 999999999999999
...
@param GetArmorCount
@text Number of armor obtained
@desc Number of armor pieces obtained
@type number
@default 0
@min 0
@max 999999999999999
...
@text Always possible to escape
@desc Always allow escape?
@type boolean
@on Always possible to escape
@off As usual
@default false

@param DebugSkill
@text Debugging Skill Enabled
@desc Enable Debugging Skills
@type boolean
@on valid
@off invalid
@default true
...
@param DebugSkills
@text Debugging skills
@desc Skills that can be used unconditionally when debugging
@type skill[]
@parent DebugSkill
*/
