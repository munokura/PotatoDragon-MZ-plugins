...
@plugindesc Shop Rate Ver1.3.5 (2023/9/11)
@author PotatoDragon
@license MIT License
...
## Overview
Sets the purchase and sale rates for the shop.

## Usage
Change the purchase rate or sell rate in the plugin parameters.
The default is the same as before the plugin was installed.

Example: The setting method for both the purchase and sell rates is the same.
- To set it to 10x: 10
- To set it to 5x: 5
- To set it to 2x: 2
- To set it to the same price: 1
- To set it to half price: 0.5
- To set it to 1/4: 0.25
- To set it to 1/10: 0.1

When installing CurrencyUnit.js, this plugin setting is disabled.
Please set the rate using the plugin parameters in CurrencyUnit.js.
