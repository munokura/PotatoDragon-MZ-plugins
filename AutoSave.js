...
@plugindesc Autosave option Ver1.0.6 (2025/1/18)
@author PotatoDragon
@license MIT License
...
## Overview
Adds an option to enable or disable autosave.

## How to Use
1. Install the plugin.
2. Autosave will be added to the options.
3. Turn autosave ON to enable it. Turn it OFF to disable it.
*/
