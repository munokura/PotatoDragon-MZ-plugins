...
@plugindesc Member State Ver1.0.0 (2025/1/1)
@author PotatoDragon
@license MIT License
...
## Overview
Create a member state that applies to each member count.

## How to Use
1. Create a member state that applies to each member count.
Check "Release at end of battle."
2. Set the member state in the plugin parameters.
3. A member state is granted for each member count in battle.

@param MemberStates
@text Member State
@desc Member State Settings
