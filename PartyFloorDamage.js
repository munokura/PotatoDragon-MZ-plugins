...
/*:
@target MZ
@url https://raw.githubusercontent.com/pota-gon/RPGMakerMZ/refs/heads/main/plugins/System/PartyFloorDamage.js
@plugindesc Party Floor Damage Rate Ver1.0.3 (2025/1/18)
@author PotatoDragon
@license MIT License
...
## Overview
Adds a party ability version of the special ability value: Floor Damage Rate.

## Usage
Enter <Floor Damage Rate: 50%> in the memo field of an actor, class, weapon,
armor, or state.
Then, the floor damage rate will be applied to the entire party.

The party floor damage rate will be the smallest value (the value that results
in the least damage) of the normal floor damage rate.
