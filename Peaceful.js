...
/*:
@target MZ
@url https://raw.githubusercontent.com/pota-gon/RPGMakerMZ/refs/heads/main/plugins/Config/Option/Peaceful.js
@plugindesc Peaceful Ver. 1.0.2 (July 3, 2023)
@author PotatoDragon
@license MIT License
...
## Overview
Adds an option to disable random encounters, similar to Minecraft's Peaceful
setting.

## How to Use
A "Peaceful" option has been added to Menu > Options.

Toggle to disable random encounters.

With Peaceful ON, random encounters are disabled.
With Peaceful OFF, random encounters are enabled.
