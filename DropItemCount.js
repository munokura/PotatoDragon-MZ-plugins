...
/*:
@target MZ
@url https://raw.githubusercontent.com/pota-gon/RPGMakerMZ/refs/heads/main/plugins/Battle/DropItemCount.js
@plugindesc Drop Item Quantity Display Ver1.3.6 (2023/7/12)
@author PotatoDragon
@license MIT License
...
## Overview
Displays the total number of dropped items.

## Usage
Simplifies the display when multiple identical items are dropped.
You can also change the detailed display information using parameters.
...
### After Installation
I got two potions!
*An icon will also appear before the item name.

@param ObtainItemMessage
@text Item acquisition message
@desc Message when obtaining an item. If left blank, it will not be displayed.
@type multiline_string
@default \I[%1]%2を%3個手に入れた！

@param OneItemMessage
@text Message when receiving 1 item
@desc Message when obtaining one item. If left blank
@type multiline_string
*/
