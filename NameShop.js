...
@plugindesc Name Shop Ver1.3.8 (2025/1/18)
@author PotatoDragon
@license MIT License
...
## Overview
Specify a name to call a shop process.

## Usage
1. Select the "Name Shop" plugin command.
2. Configure the shop using the plugin command.
3. When you call an event, the configured shop will be called.

@command name_shop_item
@text Name Shop
@desc Calling a shop process by name
@arg goods
@text Product List
...
@arg buyOnly
@text Purchase only
@desc Should I just buy it?
@type boolean
@on Purchase only
@off Buying and selling
@default false
*/
