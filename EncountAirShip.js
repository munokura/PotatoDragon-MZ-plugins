...
@plugindesc Airship Encounter Ver. 1.0.0 (2025/1/1)
@author PotatoDragon
@license MIT License
...
## Overview
Encounters will now occur via airship.

## How to Use
1. In the map encounter settings, set the airship region (default is 255).

2. Change the airship battle background as needed using the parameters Airship
Battle Background 1 and Airship Battle Background 2.

3. Encounters will now occur when boarding an airship.

@param Region
@text Encounter Region
@desc Region number to use when encountering by airship
@type number
@default 255

@param AirShipBattleback1Name
@text Airship Battle Background 1
@desc Specify airship battlebacks1
@type combo
@default Clouds
@option Castle1
@option Castle2
...
@text Airship Battle Background 2
@desc Specify airship battlebacks 2 (battlebacks1)
@type combo
@default Clouds
@option Brick
@option Bridge
