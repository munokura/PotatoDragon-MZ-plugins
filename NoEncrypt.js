...
@plugindesc Save encryption decryption Ver1.2.6 (2024/11/20)
@author PotatoDragon
@license MIT License
...
## Overview
This changes the settings so that save contents are not encrypted or
compressed.
...
Saves created before installing this plugin will become unreadable and
unwritable, so please delete them or save and overwrite them.

Also, since compression will not be performed, we recommend disabling or
removing the plugin before publishing your game.
...
@desc Whether to format JSON when saving
@type boolean
@on to shape
@off No plastic surgery
@default true
*/
