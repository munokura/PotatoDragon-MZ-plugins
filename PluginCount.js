...
/*:
@target MZ
@url https://raw.githubusercontent.com/pota-gon/RPGMakerMZ/refs/heads/main/plugins/Base/Debug/PluginCount.js
@plugindesc Plugin Count Ver1.0.3 (2025/1/18)
@author PotatoDragon
@license MIT License
...
## Overview
Displays the total number of plugins and the number of active plugins.
...
@param ShowPlayName
@text Plug-in name display
@desc Show plugin name?
@type boolean
@on Show
@off Do not display
@default false
